...
We shall denote by $\hat\pi\colon \hat\cC\to \MM_{1,n}(1)$ the universal curve (and use similar notation for all its pullbacks). We shall also consider the universal Picard stack $\mathfrak{Pic}^{\rm{tot deg}=d,\rm{st}}_{1,n}(1)$ of $\hat\cC\to \mathfrak M_{1,n}^{\rm{wt}=d,\rm{st}}(1)$ with universal line bundle $\hat{\mathcal{L}}$. We shall often use shorthand notation $\hat\MM$ for $\mathfrak M_{1,n}^{\rm{wt}=d,\rm{st}}(1)$ and $\hat{\mathfrak P}$ for $\mathfrak{Pic}^{\rm{tot deg}=d,\rm{st}}_{1,n}(1)$. Let $\hat\lambda$ denote the projection $\hat{\mathfrak P}\to \hat\MM$.
